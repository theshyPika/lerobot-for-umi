...
BATCH_SIZE=64
CHUNK_SIZE=50              # 与配置的 chunk_size / n_action_steps 对齐
PRETRAINED_PATH=lerobot/pi05_base #可修改为本地路径
RESUME=false              # 若要从中断继续，置为 true 并填写 RESUME_CONFIG_PATH
RESUME_CONFIG_PATH=null
JOB_NAME=pi05_g2_g7_smoke
# 导出得到的 LeRobot 数据集根目录（port_phys_twin.py 的 --save-path）
DATA_PATH=/tmp/g2_exports/g2_g7_smoke/
DATASET_REPO_ID=g2_g7_smoke
#输出保存目录
OUTPUT_PATH=/data2/exp/output_pi05_g2_g7_smoke
# 相对动作
