...
# RESUME_CONFIG_PATH=/data2/exp/output_pi05_g2_right_arm_g3/checkpoints/last/pretrained_model/train_config.json
RESUME_CONFIG_PATH=null
JOB_NAME=pi05_g2_dual_arm_g3
# 导出得到的 LeRobot 数据集根目录（port_phys_twin.py 的 --save-path）
DATA_PATH=/data1/training_data/teleop/g2/g2_dual_arm_g3
DATASET_REPO_ID=g2_dual_arm_g3
#输出保存目录
OUTPUT_PATH=/data2/exp/finetune_models/teleop/g2/output_pi05_g2_dual_arm_relative_g3
# 相对动作
...
if [ "${RESUME}" = "true" ]; then
  accelerate launch \
    ...
    --policy.device=cuda \
    --rename_map='{"observation.images.head_color":"observation.images.base_0_rgb", "observation.images.hand_left_color":"observation.images.left_wrist_0_rgb", "observation.images.hand_right_color":"observation.images.right_wrist_0_rgb"}' \
